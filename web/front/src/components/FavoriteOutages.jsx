    ...
    return (
      <section className="card p-4 md:p-5 border-amber-500/20">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h2 className="text-[17px] sm:text-base md:text-sm font-semibold text-amber-200">علاقه‌مندی‌ها</h2>
  ...
  return (
    <section className="card p-4 md:p-5 border-amber-500/20 bg-gradient-to-br from-amber-500/[0.04] to-transparent">
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="flex items-center gap-2">
          <button
            className="btn-ghost text-[13px] sm:text-xs md:text-[11px] px-2 py-1 h-9 sm:h-8"
            onClick={onRefresh}
