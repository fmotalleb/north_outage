  ...
  return (
    <section className="card p-4 md:p-5">
      <div className="flex items-start justify-between gap-3 mb-3">
        <div>
          <h2 className="text-[15px] sm:text-sm font-semibold text-slate-100 flex items-center gap-2">
...
className={`w-full text-right rounded-xl px-3 py-3 sm:py-2.5 transition border ${
                  active
              ...
              >
                <div className="flex items-center justify-between gap-3">
                  <div className="min-w-0">
                    <div className={`text-[15px] sm:text-sm font-semibold ${active ? 'text-cyan-100' : 'text-slate-100'}`}>
                      {p.name}
                    </div>
                    <div className="text-[13px] sm:text-xs md:text-[11px] text-slate-400 mt-0.5 line-clamp-2">{p.description}</div>
                  </div>
                <div
      ...
      <p className="mt-3 text-[12px] sm:text-[11px] md:text-[10px] text-slate-500 leading-relaxed">
